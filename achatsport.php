...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <h6 class="heading">- SPORT ET LOISIR -</h6>
      <p>- BALLON - RAQUETTE - SPORT D'HIVER - VELO -</p>
    </div>

    <p id="Ballon">Ballons : </p>
      ...
      <li>
       ...
       <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Nom, Marque, Prix, Nbvendu,Image FROM sport WHERE Cat LIKE 'Ballon' Order by Prix";
      ...
      <li>
       ...
       <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Nom, Marque, Prix, Nbvendu,Image FROM sport WHERE Cat LIKE 'Raquette' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de Raquettes en stock';
					}
      ...
      <li>
        ...
        <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Nom, Marque, Nbvendu,Image, Prix FROM sport WHERE Cat LIKE 'Sport' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de matériel de sport en stock';
					}
      ...
      <li>
        ...
        <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Nom, Marque, Nbvendu,Image, Prix FROM sport WHERE Cat LIKE 'Velo' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
