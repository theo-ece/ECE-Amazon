...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      <h6 class="heading">- Livres -</h6>
      <p>- JEUNESSE - AVENTURE - POLICIER - SCIENCES FICTION - CLASSIQUES -</p>
    </div>

    <p id="Jeunesse">Livres Jeunesse : </p>
      ...
      <li>
       ...
       <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Titre, Auteur, Prix, Nbvendu,Image FROM livre WHERE Cat LIKE 'Jeunesse' Order by Prix";
    ...
    <p id="Aventure">Livres Aventure : </p>
    <ul class="nospace group services">
      <li>
      	<article class="inverse"><a href="#"></a>
       <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Titre, Auteur, Prix, Nbvendu,Image FROM livre WHERE Cat LIKE 'Aventure' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de livres aventure en stock';
					}
    ...
    <p id="Policier">Livres Policier : </p>
    <ul class="nospace group services">
      <li>
        ...
        <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Titre, Auteur, Prix, Nbvendu,Image FROM livre WHERE Cat LIKE 'Policier' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de livres policiers en stock';
					}
    ...
    <p id="ScienceF">Livres Science Fiction : </p>
    <ul class="nospace group services">
      <li>
        <article class="inverse"><a href="#"></a>
          <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Titre, Auteur, Prix, Nbvendu,Image FROM livre WHERE Cat LIKE 'ScienceF' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de livres de science fiction en stock';
					}
    ...
    <p id="Classique">Livres Classiques : </p>
    <ul class="nospace group services">
      <li>
        <article class="inverse"><a href="#"></a>
                    <?php
				...
				if ($db_found) 
				{
					...
					$sql= "SELECT Titre, Auteur, Prix, Nbvendu,Image FROM livre WHERE Cat LIKE 'Classique' Order by Prix";
					$result = mysqli_query($db_handle,$sql);
					$Nbdata = mysqli_num_rows($result);
					$Nbcol=4;
					$Nbligne =0;
		...
		?>
					...
					echo 'pas de livres classiques en stock';
					}
